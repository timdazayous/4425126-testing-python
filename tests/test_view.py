...
# capsys permet d'intercepter toiut ce uqe la fonction imprime sur la sortie standard print-> stdout
# intercpeter les eventuels messages d'erreur
# les recuperer via out, err = capsys.readrouterr
def test_affichage_menu(capsys):
    View.print_menu()
